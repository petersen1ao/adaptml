...
setup(
    ...
    version="0.1.0",
    author="AdaptML Team",
    author_email="hello@adaptml.ai",
    description="Cut AI inference costs by 50% with adaptive model selection",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/yourusername/adaptml",
    project_urls={
        "Bug Tracker": "https://github.com/yourusername/adaptml/issues",
        "Documentation": "https://adaptml.readthedocs.io",
        "Source Code": "https://github.com/yourusername/adaptml",
    },
    ...
    entry_points={
        "console_scripts": [
            "adaptml-demo=adaptml.core:main",
        ],
    },
    keywords="ai ml inference optimization pytorch tensorflow onnx mobile edge adaptive",
